...
//#define SWITCHING_EXTRUDER
  ...
  #define SWITCHING_EXTRUDER_SERVO_ANGLES { 0, 100 } // Angles for E0, E1[, E2, E3]
  #if EXTRUDERS > 3
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 4000, 141.47}
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          {300, 300, 3.3, 40}
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -17 // Z offset: -below +above  [the nozzle]
